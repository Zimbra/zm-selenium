...
public class ZimletItem {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((gFolderTreeName == null) ? 0 : gFolderTreeName.hashCode());
		result = prime * result + ((gPreferencesName == null) ? 0 : gPreferencesName.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		// If folder name are equal OR If preference name are equal, then objects are
		// equal
	...
	public static class CoreZimletItem extends ZimletItem {
		...
		public enum CoreZimletName {
			com_zimbra_attachcontacts, com_zimbra_attachmail, com_zimbra_date, com_zimbra_dnd, com_zimbra_email, com_zimbra_linkedin, com_zimbra_linkedinimage, com_zimbra_phone, com_zimbra_social, com_zimbra_srchhighlighter, com_zimbra_url, com_zimbra_webex
		}
