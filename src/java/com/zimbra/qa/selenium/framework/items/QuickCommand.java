...
public class QuickCommand {
	...
	public static class QuickCommandAction {
		...
		public enum TypeId {
			actionTag, actionFlag, actionFileInto, Null
		}
	...
	public static void main(String[] args) throws HarnessException {
		...
		/**
		 * <ModifyPrefsRequest xmlns="urn:zimbraAccount"> <pref name=
		 * "zimbraPrefQuickCommand">{"id":1,"itemTypeId":"MSG","name":"qcname","description":"qcdescription","isActive":true,"actions":[{"id":1,"typeId":"actionTag","value":"257","isActive":true},{"id":2,"typeId":"actionFlag","value":"unread","isActive":true}]}</pref>
		 * <pref name=
		 * "zimbraPrefQuickCommand">{"id":2,"itemTypeId":"CONTACT","name":"qcname2","description":"qcdescription2","isActive":true,"actions":[{"id":1,"typeId":"actionTag","value":"258","isActive":true},{"id":2,"typeId":"actionFileInto","value":"2","isActive":true}]}</pref>
		 * </ModifyPrefsRequest>
		 */
