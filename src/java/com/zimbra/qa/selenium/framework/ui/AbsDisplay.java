 ...
 * <p>
 * Displayed objects are usually returned after opening or selecting an object
 * from a list, such as double-clicking on a message from the mail message list
 * view.
 * <p>
 * The Display object allows the test method to access displayed information,
 * such as To addresses, subject, message body, contact field, appointment start
 * time, etc.
 * <p>
 * 
 * @author Matt Rhoades
