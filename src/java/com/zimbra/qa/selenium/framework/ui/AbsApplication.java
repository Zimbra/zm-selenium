 ...
 * <p>
 * The <code>Application</code> object is the main access point for the test
 * methods to access the GUI. The application contains a list of {@link AbsTab}
 * objects, {@link AbsTree} objects, and other GUI objects. Test case methods
 * contain an instance of the application and can access the GUI pages using the
 * application object. The application is initialized during test class
 * construction.
 * <p>
 * Additionally, the <code>Application</code> object has data specific to the
 * current running client, such as currently logged in {@link ZimbraAccount},
 * the current localization {@link I18N}, etc.
 * <p>
 * 
 * @author Matt Rhoades
 *
...
public abstract class AbsApplication {
	 ...
	 * 
	 * @see <a href=
	 *      "http://wiki.zimbra.com/wiki/Testing:_Selenium:_ZimbraSelenium_Overview#Mail_Page">Screen
	 *      reference</a>
	 * @return
	 * @throws HarnessException
	 */
	 ...
	 * <p>
	 * This method is used by the implementing classes to set the authenticated
	 * account.
	 * <p>
