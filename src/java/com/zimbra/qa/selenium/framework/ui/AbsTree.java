...
/**
 * A <code>AbsTree</code> object represents a "tree panel", such as a Folder
 * tree, Addressbook tree, Calendar tree, etc.
 * <p>
 * 
 * @author Matt Rhoades
 *
...
public abstract class AbsTree extends AbsPage {
	 ...
	 * Action is Action.A_LEFTCLICK and the Button would be the context menu item,
	 * such as Button.B_DELETE
	 * <p>
	 * 
	 * @param action
	 * @param addressbook
