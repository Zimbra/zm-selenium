	 ...
	 * <p>
	 * <p>
	 * Action constant names start with "C_" for CheckBoxs and take the general format
	 * <code>C_PAGE_TEXT</code>,
	 * where "Page" is the application name such as MAIL, ADDRESSBOOK, and
	 * "Text" is the displayed English text on the Checkbox.  For non-page
	 * specific CheckBoxes, the "Page" is not specified.
	 * <p>
