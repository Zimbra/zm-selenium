...
public class Stafpostqueue extends StafServicePROCESS {
	...
	public void waitForPostqueue() throws HarnessException {
		 ...
		 * Example "output":
		 * 
		 * -Queue ID- --Size-- ----Arrival Time---- -Sender/Recipient------- A391E167584
		 * 1164 Thu Jun 30 11:23:15 zimbra@server (delivery temporarily suspended:
		 * connect to server[10.137.245.174]:7025: Connection refused) admin@server
		 * 
		 * 03E3A16757E 2012 Thu Jun 30 11:25:52 enus130945819697629@testdomain.com
		 * (delivery temporarily suspended: connect to server[10.137.245.174]:7025:
		 * Connection refused) enus130945833860146@testdomain.com
		 * 
		 * 48E6016757B 1164 Thu Jun 30 11:21:46 zimbra@server (connect to
		 * server[10.137.245.174]:7025: Connection refused) admin@server
		 * 
		 * 9A588167581 1164 Thu Jun 30 11:23:15 zimbra@server (delivery temporarily
		 * suspended: connect to server[10.137.245.174]:7025: Connection refused)
		 * admin@server
		 * 
		 * 
