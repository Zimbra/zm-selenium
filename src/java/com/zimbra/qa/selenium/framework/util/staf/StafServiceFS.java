...
public class StafServiceFS extends StafAbstract {
	...
	/**
	 * FS COPY only supports one direction, from local machine to destination
	 * machine. So, if you need to copy from a remote system, you must initiate the
	 * request from the remote machine to the local machine. In this case, set the
	 * "host" parameter to the remote system and the TOMACHINE to the local system.
	 * 
	 * @param host
	 */
