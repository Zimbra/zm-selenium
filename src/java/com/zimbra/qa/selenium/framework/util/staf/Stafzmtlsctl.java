...
public class Stafzmtlsctl extends StafServicePROCESS {
	...
	public void setServerAccess(SERVER_ACCESS serverAccess) throws HarnessException {
		String setting = null;
		...
		String mode = stafServicePROCESS.getStafResponse().split(serverName)[1].split("}")[0]
				.split("zimbraMailMode:")[1].trim();
