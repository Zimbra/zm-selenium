...
public class BuildUtility {
   ...
   private static String _getHtmlInfo(String url) throws HarnessException {
      ...
      return results;
      // For example: wget -m -nd -P C:\Jeff_Test\ http://buildserver/links/WINDOWS/HELIX/20110110070101_ZDESKTOP/ZimbraBuild/i386/zdesktop_7_0_dev-helix_b10684_win32.msi
   }
