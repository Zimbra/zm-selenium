...
public static synchronized RacetrackWebservice
    ...
    * https://wikiurl/RacetrackWebServices
    ...
    * http://bugzilla.server.com/show_bug.cgi?id=373374
    *
    ...
    * for more info:
    * https://wikiurl/RacetrackWebServices#TestSetData
    *
    * @param testSetId
    * @param name
    * @param value
    ...
    * https://wikiserver/RacetrackWebServices#TestCaseBegin
    *
    * @param testSetId
    * @param name
    * @param feature
