 ...
 * <p>
 * It would be great to use com.zimbra.soap.Element, rather than defining a
 * class in the Selenium Harness. However, Element does not allow content + tags
 * within elements: "cannot set text on element with children".
 * <p>
 * If that issue is resolved with Element, then this HtmlElement class should be
...
public class HtmlElement {
	 ...
	 * <p>
	 * This method uses ZAssert to check the element matches the specified
	 * arguments.
	 * <p>
	 * 
	 * @param element
	 ...
	 * @param xpath
	 *            The xpath to apply (null uses the root node of the element)
	 * @param attribute
	 *            If non-null, apply regex to the attribute value
	 * @param regex
	 *            If non-null, match the regex to the node text or attribute value
	 * @param occurences
	 *            The number of nodes that should match
	 * @throws HarnessException
	 */
	public static void evaluate(HtmlElement element, String xpath, String attribute, String compare, int occurences)
			throws HarnessException {
		if (compare == null) {
	 ...
	 * @throws HarnessException
	 */
	public static void evaluate(HtmlElement element, String xpath, String attribute, Pattern regex, int occurences)
			throws HarnessException {
		String message = String.format("xpath(%s), attr(%s), regex(%s), occurences(%d)", xpath, attribute, regex,
				occurences);
				...
				if (o instanceof TagNode) {
					...
					if (attribute != null) {
						...
						if (!node.hasAttribute(attribute)) {
							// This node doesn't have the attribute, but keep checking other nodes in the
							// list
							continue;
						}
	 ...
	 * <p>
	 * See
	 * http://htmlcleaner.sourceforge.net/doc/org/htmlcleaner/PrettyHtmlSerializer.html
	 * <p>
	 * 
	 * @param node
	 * @return
