...
public class ZimbraPrefMailPollingIntervalAsMailArrives extends SetGroupMailByMessagePreference {
	...
	public ZimbraPrefMailPollingIntervalAsMailArrives() {
		...
		super.startingAccountPreferences.put("zimbraPrefMailPollingInterval", ""+ com.zimbra.qa.selenium.projects.universal.tests.preferences.mail.displayingmessages.ZimbraPrefMailPollingIntervalAsMailArrives.AsMailArrives);
	...
	public void ZimbraPrefMailPollingIntervalAsMailArrives_01() throws HarnessException {
		...
		SleepUtil.sleep(com.zimbra.qa.selenium.projects.universal.tests.preferences.mail.displayingmessages.ZimbraPrefMailPollingIntervalAsMailArrives.AsMailArrivesDelay);
