...
public class PageLogin extends AbsTab {
	...
	public void zLogin(ZimbraAccount account) throws HarnessException {
		...
		try {
			...
			((UniversalPages)MyApplication).zPageMain.zWaitForActive(100000);
			((UniversalPages)MyApplication).zSetActiveAccount(account);
	...
	public AbsPage zSetupAfterLogin(ZimbraAccount account) throws HarnessException {
		...
		AbsPage page = null;
		page = new Dialog2FactorAuthEnable(MyApplication, ((UniversalPages) MyApplication).zPageLogin);
		if ( page.zIsActive() ) {
			return (page);
		}
	...
	public void zLogin(ZimbraAccount account, String totp, boolean trustThisComputer) throws HarnessException {
		...
		try {
			...
			((UniversalPages)MyApplication).zPageMain.zWaitForActive(180000);
