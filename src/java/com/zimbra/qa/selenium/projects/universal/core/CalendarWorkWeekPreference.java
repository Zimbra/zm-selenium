...
/**
 * A base class that sets 1) the starting page to be the calendar app 2) sets
 * zimbraPrefCalendarInitialView=WorkWeek (default) 3) sets weekDayUTC ... a
 * Calendar object, on current week day
 * 
 * @author Matt Rhoades
 *
 */
public class CalendarWorkWeekPreference extends UniversalCore {
