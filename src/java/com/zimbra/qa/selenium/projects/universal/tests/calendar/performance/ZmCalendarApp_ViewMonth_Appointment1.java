...
public class ZmCalendarApp_ViewMonth_Appointment1 extends CalendarWorkWeekPreference {
	...
	public void ZmCalendarApp_03() throws HarnessException {
		...
		String filename = ConfigProperties.getBaseDirectory() + "/data/public/ics/calendar05/Calendar.ics";
		File file = null;
