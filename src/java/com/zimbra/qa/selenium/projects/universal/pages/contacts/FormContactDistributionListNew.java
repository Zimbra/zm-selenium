...
public class FormContactDistributionListNew extends AbsForm {
	...
	public AbsPage zToolbarPressPulldown(Button pulldown, Button option) throws HarnessException {
		...
		if ( pulldown == Button.B_DISTRIBUTIONLIST_SEARCH_TYPE ) {
			...
			pulldownLocator = "css=div[id$='_listSelect'] td[id$='_dropdown']";
	...
	public void zFillField(Field field, String value) throws HarnessException {
		...
		if ( field == Field.DistributionListName ) {
			...
			locator = "css=input[id$='_searchField']";
	...
	public void select(UniversalPages app, String dropdown, String option) throws HarnessException {
