 ...
 *
 */
public class QuickCommandSettings extends UniversalCore {
	protected static Logger logger = LogManager.getLogger(QuickCommandSettings.class);
	...
	public QuickCommandSettings() {
		logger.info("New "+ QuickCommandSettings.class.getCanonicalName());
