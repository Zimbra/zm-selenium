...
public class DisplayMail extends AbsDisplay {
	...
	public AbsPage zPressButton(Button button) throws HarnessException {
		...
		if (button == Button.B_REMOVE_ALL) {
			...
			page = new DialogShareAccept(MyApplication, ((UniversalPages) MyApplication).zPageMail);

		} else if (button == Button.B_DECLINE_SHARE) {

			locator = this.ContainerLocator + " td[id$='__Shr__SHARE_DECLINE_title']";
			page = new DialogShareDecline(MyApplication, ((UniversalPages) MyApplication).zPageMail);
	...
	public AbsPage zListAttachmentItem(Button button, AttachmentItem attachment) throws HarnessException {
		...
		if (button == Button.B_REMOVE) {
			...
			page = new DialogAddToCalendar(MyApplication, ((UniversalPages) MyApplication).zPageMail);
			...
			page = new DialogAddToBriefcase(MyApplication, ((UniversalPages) MyApplication).zPageMail);
