...
public class DisplayDistributionList extends AbsDisplay {
	public static String ALPHABET_PREFIX = "css=table[id$='alphabet'] td[_idx=";
	public static String ALPHABET_POSTFIX = "]";

	/**
	 * Defines Selenium locators for various objects in {@link DisplayDistributionList}
	 */
	 ...
	 * @param application
	 */
	protected DisplayDistributionList(AbsApplication application) {
		super(application);

		logger.info("new " + DisplayDistributionList.class.getCanonicalName());
