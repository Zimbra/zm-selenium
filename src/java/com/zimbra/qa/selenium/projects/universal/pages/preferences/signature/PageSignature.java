 ...
 * ***** END LICENSE BLOCK *****
 */
package com.zimbra.qa.selenium.projects.universal.pages.preferences.signature;
...
import com.zimbra.qa.selenium.projects.universal.pages.preferences.DialogSelectContact;
...
public class PageSignature extends AbsTab {
	...
	public AbsPage zToolbarPressButton(Button button) throws HarnessException {
		...
		if (button == Button.B_NEW) {
			...
			page = new DialogSelectContact(MyApplication, ((UniversalPages) MyApplication).zPageSignature);
