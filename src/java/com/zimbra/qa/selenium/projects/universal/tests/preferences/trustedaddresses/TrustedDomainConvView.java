...
public class TrustedDomainConvView extends UniversalCommonTest {
	 ...
	 */
	@Test( description = "Verify Display Image link in Trusted doamin for conversation view", groups = { "sanity", "L0"  })
