 ...
 *
 */
package com.zimbra.qa.selenium.projects.universal.pages.social;
...
public class PageSocial extends AbsTab {
	...
	private boolean zDismissWelcomeDialog() throws HarnessException {
		DialogSocialZimletWelcome dialog = new DialogSocialZimletWelcome(MyApplication, ((UniversalPages) MyApplication).zPageSocial);
		if ( dialog.zIsActive() ) {
