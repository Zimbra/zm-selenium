...
public class DialogEditFolder extends AbsDialog {
	...
	public AbsPage zPressButton(Button button) throws HarnessException {
		...
		if (button == Button.B_OK) {
			...
			page = new DialogShareRevoke(MyApplication,((UniversalPages) MyApplication).zPageMail);
	...
	public void zSetNewColor(FolderColor color, UniversalPages app) throws HarnessException {
