...
public class TreeBriefcase extends AbsTree {
	...
	public AbsPage zTreeItem(Action action, IItem item) throws HarnessException {
		...
		if (item instanceof TagItem) {
			...
			page = new DialogFindShares(MyApplication, ((UniversalPages) MyApplication).zPageBriefcase);
	...
	public AbsPage zPressButton(Button button) throws HarnessException {
		...
		if (button == Button.B_TREE_NEWBRIEFCASE) {
			...
			page = new DialogTag(MyApplication,	((UniversalPages) MyApplication).zPageBriefcase);
	...
	public boolean zIsActive() throws HarnessException {
		...
		if (!((UniversalPages) MyApplication).zPageBriefcase.zIsActive()) {
			((UniversalPages) MyApplication).zPageBriefcase.zNavigateTo();
		}
