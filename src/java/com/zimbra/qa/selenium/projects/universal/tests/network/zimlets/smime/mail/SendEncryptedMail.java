...
public class SendEncryptedMail extends AjaxCommonTest {
	...
	public void SendEncryptedMail_06() throws HarnessException  {
		...
		mail.zFillField(com.zimbra.qa.selenium.projects.universal.ui.mail.FormMailNew.Field.To, ZimbraAccount.AccountB().EmailAddress);
		mail.zFillField(com.zimbra.qa.selenium.projects.universal.ui.mail.FormMailNew.Field.Subject, subject);
		mail.zFillField(com.zimbra.qa.selenium.projects.universal.ui.mail.FormMailNew.Field.Body, body);	
	...
	@Test ( description = "Verify that Signed and encrypted message composed from a new window can be sent from Web-client", priority=4, 
			groups = {"functional", "L2", "network"})
	
	public void SendEncryptedMail_07() throws HarnessException  {
		ZimbraAccount user3 = new ZimbraAccount("user3"+ "@" + ConfigProperties.getStringProperty("testdomain", "testdomain.com"), null);
		user3.provision();
		user3.authenticate();
