...
import com.zimbra.qa.selenium.projects.universal.pages.PageMain;
...
public class PagePreferences extends AbsTab {
	...
	public AbsPage zToolbarPressButton(Button button) throws HarnessException {
		...
		if (button == Button.B_SAVE) {
			...
			page = new DialogEditFilter(MyApplication, ((UniversalPages) MyApplication).zPagePreferences);
			...
			page = new DialogWarning(DialogWarningID.DeleteFilterWarningMessage, MyApplication,
					((UniversalPages) MyApplication).zPagePreferences);
			...
			page = new DialogActivityStream(MyApplication, ((UniversalPages) MyApplication).zPagePreferences);

		} else if (button == Button.B_NEW_QUICK_COMMAND) {

			locator = "css=div[id='zb__QCV__ADD_QUICK_COMMAND'] td[id$='_title']";
			page = new DialogEditQuickCommand(MyApplication, ((UniversalPages) MyApplication).zPagePreferences);
	...
	public AbsPage zPressButton(Button button) throws HarnessException {
		...
		if (button == Button.B_CUSTOMIZE) {
			...
			page = new DialogAddApplicationCode(MyApplication, ((UniversalPages) MyApplication).zPagePreferences);
			...
			page = new DialogInformational(DialogInformational.DialogWarningID.InformationalDialog, this.MyApplication,
					((UniversalPages) this.MyApplication).zPagePreferences);
