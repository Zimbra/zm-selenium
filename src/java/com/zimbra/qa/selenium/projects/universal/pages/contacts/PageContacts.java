...
public class PageContacts extends AbsTab {
	...
	public void zNavigateTo() throws HarnessException {
		...
		((UniversalPages) MyApplication).zPageMain.zCheckAppLoaded(Locators.zContactsFolder);
	}
	...
	public AbsPage zKeyboardShortcut(Shortcut shortcut) throws HarnessException {
		...
		if (shortcut == Shortcut.S_NEWTAG) {
			page = new DialogTag(MyApplication, ((UniversalPages) MyApplication).zPageContacts);
			...
			page = new DialogAssistant(MyApplication, ((UniversalPages) MyApplication).zPageContacts);
	...
	public void clickDistributionListsFolder(UniversalPages app) throws HarnessException {
	...
	public AbsPage zToolbarPressPulldown(Button pulldown, Button option) throws HarnessException {
		...
		if (pulldown == Button.B_TAG) {
			...
			if (option == Button.O_NEW_CONTACT) {
				...
				page = new DialogCreateFolder(MyApplication, ((UniversalPages) MyApplication).zPageContacts);
		...
		if (action == Action.A_RIGHTCLICK) {
			...
			if (option == Button.B_TAG) {
				...
				if (subOption == Button.O_NEW_CONTACTGROUP) {
					...
					page = new DialogNewContactGroup((UniversalPages) MyApplication, this);
				}
				...
				if (subOption == Button.O_SEARCH_MAIL_SENT_TO_CONTACT) {
					...
					page = ((UniversalPages) MyApplication).zPageSearch;
