...
public class ForwardMail extends SetGroupMailByMessagePreference {
	...
	public void ForwardMail_01() throws HarnessException {
		...
		ZAssert.assertTrue(app.zPageMail.zVerifyDisplayMailElement("div[id='zimbraEditorContainer'] div table[border='1']"), "Verify Excel Table border ");
		ZAssert.assertStringContains(actual.zGetMailProperty(com.zimbra.qa.selenium.projects.universal.pages.mail.DisplayMail.Field.Body), "ID", "Verify the body content matches");
		ZAssert.assertStringContains(actual.zGetMailProperty(com.zimbra.qa.selenium.projects.universal.pages.mail.DisplayMail.Field.Body), "Fname", "Verify the body content matches");
		ZAssert.assertStringContains(actual.zGetMailProperty(com.zimbra.qa.selenium.projects.universal.pages.mail.DisplayMail.Field.Body), "Lname", "Verify the body content matches");
		ZAssert.assertStringContains(actual.zGetMailProperty(com.zimbra.qa.selenium.projects.universal.pages.mail.DisplayMail.Field.Body), "Test1", "Verify the body content matches");
		ZAssert.assertStringContains(actual.zGetMailProperty(com.zimbra.qa.selenium.projects.universal.pages.mail.DisplayMail.Field.Body), "Test2", "Verify the body content matches");
		ZAssert.assertStringContains(actual.zGetMailProperty(com.zimbra.qa.selenium.projects.universal.pages.mail.DisplayMail.Field.Body), "Test3", "Verify the body content matches");
		ZAssert.assertStringContains(actual.zGetMailProperty(com.zimbra.qa.selenium.projects.universal.pages.mail.DisplayMail.Field.Body), "Test4", "Verify the body content matches");
	}
}