...
public class PageTasks extends AbsTab{
	...
	public static class Locators {
		...
		public static final String zNewTask = "css=div[id='zb__NEW_MENU'] td[id='zb__NEW_MENU_title']";
	...
	public void zNavigateTo() throws HarnessException {
		...
		((UniversalPages) MyApplication).zPageMain.zCheckAppLoaded(Locators.zTasksFolder);
	}
	...
	public AbsPage zKeyboardShortcut(Shortcut shortcut) throws HarnessException {
		...
		if ( (shortcut == Shortcut.S_NEWTAG) ) {
			...
			page = new DialogWarning(
					...
					this.MyApplication,
					((UniversalPages)this.MyApplication).zPageTasks);	

			keyCode = "27";

		} else if ( shortcut == Shortcut.S_ASSISTANT ) {			
			page = new DialogAssistant(MyApplication, ((UniversalPages) MyApplication).zPageTasks);
			keyCode= "192";
			...
			page = new DialogWarning(
					...
					MyApplication, ((UniversalPages) MyApplication).zPageTasks);
