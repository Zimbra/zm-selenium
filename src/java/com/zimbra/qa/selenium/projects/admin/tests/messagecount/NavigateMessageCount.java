...
public class NavigateMessageCount extends AdminCore {
	...
	public void NavigateMessageCount_01() throws HarnessException {
		...
		ZAssert.assertTrue(app.zPageManageMessageCount.zVerifyHeader(PageManageMessageCount.Locators.MESSAGE_COUNT),
				"Verfiy the 'Message Count' text exists in navigation path");
	}
}