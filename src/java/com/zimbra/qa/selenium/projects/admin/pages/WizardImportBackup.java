...
public class WizardImportBackup extends AbsWizard {
	
	public static class Locators {
		public static final String SOURCE_PATH = "css=div[style*='z-index: 7'] input[id^='zdlgv__UNDEFINE_'][id$='importPath']";
		public static final String SELECT_ALL_DOMAIN = "css=div[style*='z-index: 7'] td.ZWidgetTitle:contains('Select All >>')";
		public static final String SELECT_ACCOUNT_BUTTON = "css=div[style*='z-index: 7'] td[id$='_SelectBTN_3___container']";
		...
		public static final String SELECT_ALL_ACCOUNTS = "css=div[class='DwtDialog'][style*='display: block'] div[class='XFormCase'][style*='visibility: visible'] td.ZWidgetTitle:contains('Select All >>')";
	}
	
	public WizardImportBackup(AbsTab page) {
		super(page);
	...
	public IItem zCompleteWizard(IItem item) throws HarnessException {
		...
		sType(Locators.SOURCE_PATH, backup.getImportSourcePath());
		...
		zType(Locators.FILTER_TEXT_BOX, backup.getEmailAddress());
		SleepUtil.sleepMedium();
		sClickAt(Locators.SELECT_ALL_ACCOUNTS, "");
