...
import com.zimbra.qa.selenium.projects.admin.pages.PageManageServerStatus;

public class NavigateServerStatus extends AdminCore {
	...
	public void NavigateServerStatus_01() throws HarnessException {
		...
		ZAssert.assertTrue(app.zPageManageServerStatus.zVerifyHeader(PageManageServerStatus.Locators.SERVER_STATUS),
				"Verfiy the 'Server Status' text exists in navigation path");
	}
}