...
public class InvalidateSession extends AdminCommonTest {
	...
	@Test (description = "Invalidate Session -- manage account > right click > Invalidate Session",
		...
		// Right click account >>  Invalidate Session
		app.zPageManageAccounts.zToolbarPressButton(Button.B_INVALIDATE_SESSIONS);
		...
		// Verify toast message should be displayed regarding session is invalidated for an account
	     ...
	     ZAssert.assertStringContains(app.zPageManageAccounts.zGetToaster().zGetToastMessage(),expectedMsg, "Verify toast message '" + expectedMsg + "'");
	...
	/**
	 * Testcase : Invalidate Session from search list view
	 * Steps :
	 * 1. Create an account using SOAP.
	 * 2. Search account. 
	 * 3. Select an Account.
	 * 4. Invalidate Session
	 * 5. Verify toast message is displayed
	 * 
	 * @throws HarnessException
	 */
