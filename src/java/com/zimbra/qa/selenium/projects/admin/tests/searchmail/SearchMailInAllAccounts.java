...
public class SearchMailInAllAccounts extends AdminCommonTest {

	public SearchMailInAllAccounts() {
		logger.info("New "+ SearchMailInAllAccounts.class.getCanonicalName());
	...
	@Test( description = "Create new mail search",
			groups = { "smoke","network" })
	public void SearchMailInAllAccounts_01() throws HarnessException {
		...
		form.setTargetMailbox(emailAddress);
		...
		ZAssert.assertTrue(app.zPageManageSearchMail.zVerifySearchResult(emailAddress), "Verfiy email address is returned in search result");
