...
import com.zimbra.qa.selenium.projects.admin.pages.PageManageMailQueues;

public class NavigateMailQueues extends AdminCore {
	...
	public void NavigateMailQueues_01() throws HarnessException {
		...
		ZAssert.assertTrue(app.zPageManageMailQueues.zVerifyHeader(PageManageMailQueues.Locators.MAIL_QUEUES_TEXT),
				"Verfiy the 'Mail Queues' text exists in navigation path");
	}
}