...
public class NavigateAdminExtensions extends AdminCore {
	...
	public void NavigateAdminExtensions_01() throws HarnessException {
		...
		ZAssert.assertTrue(
				app.zPageManageAdminExtensions.zVerifyHeader(PageManageAdminExtensions.Locators.ADMIN_EXTENSIONS),
				"Verfiy the 'Admin Extensions' text exists in navigation path");
	}
}