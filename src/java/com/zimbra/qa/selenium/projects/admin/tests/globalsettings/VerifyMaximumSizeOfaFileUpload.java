...
public class VerifyMaximumSizeOfaFileUpload extends AdminCore {
	...
	public void VerifyMaximumSizeOfaFileUpload_01() throws HarnessException {
		...
		String check_label_for_fileUploadMaxSizeLabel = app.zPageManageGlobalSettings
				.sGetText(PageManageGlobalSettings.Locators.ZIMBRA_FILE_UPLOAD_MAX_SIZE);
		ZAssert.assertStringContains(check_label_for_fileUploadMaxSizeLabel, fileUploadMaxSizeLabel,
				"Verify label is correct!");

		// Verify default value for fileUploadMaxSize field
		String check_default_value = app.zPageManageGlobalSettings
				.sGetValue(PageManageGlobalSettings.Locators.ZIMBRA_FILE_UPLOAD_MAX_SIZE_TEXT_FIELD);
		...
		app.zPageManageGlobalSettings.sType(PageManageGlobalSettings.Locators.ZIMBRA_FILE_UPLOAD_MAX_SIZE_TEXT_FIELD,
				"10241");
		String check_updated_value = app.zPageManageGlobalSettings
				.sGetValue(PageManageGlobalSettings.Locators.ZIMBRA_FILE_UPLOAD_MAX_SIZE_TEXT_FIELD);
