...
public class EnableArchiving extends AdminCommonTest {
	...
	public void EnableArchiving_01() throws HarnessException {
		...
		//Select enable archiving under under Archiving Configuration
		app.zPageManageMTA.zCheckboxSet(Checkbox.C_MTA_ENABLE_ARCHIVING, true);			
		...
		ZAssert.assertTrue(app.zPageManageMTA.sIsElementPresent(Locators.ENABLE_ARCHIVING + "[checked='']"),"MTA archiving changes are reflected in Admin UI after saving and refresh.");
