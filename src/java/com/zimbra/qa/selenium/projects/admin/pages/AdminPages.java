...
public class AdminPages extends AbsApplication {
	...
	public PageZextrasHSM zPageZextrasHSM = null;
	...
	private AdminPages() {
		...
		zPageZextrasAdmin = new PageZextrasAdmin(this);
		pages.put(zPageZextrasAdmin.myPageName(), zPageZextrasAdmin);

		zPageZextrasBackup = new PageZextrasBackup(this);
		pages.put(zPageZextrasBackup.myPageName(), zPageZextrasBackup);

		zPageZextrasHSM = new PageZextrasHSM(this);
		pages.put(zPageZextrasHSM.myPageName(), zPageZextrasHSM);
	...
	public void provisionAuthenticateDA() throws HarnessException {
		...
		ZimbraAdminAccount.GlobalAdmin()
				.soapSend("<ModifyAccountRequest xmlns='urn:zimbraAdmin'>" + " <id>" + delegatedAdmin.ZimbraId + "</id>"
						...
						+ "<a n='zimbraAdminConsoleUIComponents'>domainListView</a>" + "</ModifyAccountRequest>");
