...
public class DA_ResourceLocationAMD extends AdminCommonTest {

	public DA_ResourceLocationAMD() throws HarnessException {
		logger.info("New "+ DA_ResourceLocationAMD.class.getCanonicalName());
	...
	@Test(	description = "Delegated Admin's Create a basic resource location using New -> resource",
			groups = { "sanity" })
	public void DA_CreateResource_01() throws HarnessException {
	...
	@Test(	description = "Delegated Admin's: Delete a basic  resource location -- Manage  resource  View",
			groups = { "sanity" })
	public void DA_DeleteResource_01() throws HarnessException {
	...
	@Test(	description = "Delegated Admin's : Edit Account name  - Manage Account View",
			groups = { "sanity" })
	public void DA_EditResource_01() throws HarnessException, ServiceException {
