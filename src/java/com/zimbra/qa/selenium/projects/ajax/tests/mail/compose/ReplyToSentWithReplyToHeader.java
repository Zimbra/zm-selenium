...
public class ReplyToSentWithReplyToHeader extends SetGroupMailByMessagePreference {

	ZimbraAccount account1 = null;
	ZimbraAccount account2 = null;

	public ReplyToSentWithReplyToHeader() {
		logger.info("New "+ ReplyToSentWithReplyToHeader.class.getCanonicalName());
	}
