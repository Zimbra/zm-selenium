...
public class PreferencesTabDisabled extends AjaxCore {

	@SuppressWarnings("serial")
	public PreferencesTabDisabled() {
		logger.info("New "+ PreferencesTabDisabled.class.getCanonicalName());
	...
	public void PreferencesTabDisabled_01() throws HarnessException {
