...
public class UnTagMail extends SetGroupMailByMessagePreference {
	...
	public void UnTagMail_01() throws HarnessException {
		...
		app.zGetActiveAccount().soapSend("<GetMsgRequest xmlns='urn:zimbraMail'>" + "<m id='"
	...
	public void UnTagMail_02() throws HarnessException {
		...
		// Create a tag
		app.zGetActiveAccount().soapSend("<CreateTagRequest xmlns='urn:zimbraMail'>" + "<tag name='"
						+ tagname + "' color='1' />" + "</CreateTagRequest>");
		...
		app.zGetActiveAccount().soapSend("<GetMsgRequest xmlns='urn:zimbraMail'>" + "<m id='" + mail.getId() + "'/>" + "</GetMsgRequest>");
	...
	public void UnTagMail_03() throws HarnessException {
		...
		// Create a tag
		app.zGetActiveAccount().soapSend(
				"<CreateTagRequest xmlns='urn:zimbraMail'>" + "<tag name='" 	+ tagname + "' color='1' />" + "</CreateTagRequest>");
		String tagid = app.zGetActiveAccount().soapSelectValue("//mail:CreateTagResponse/mail:tag", "id");
