...
public class DriveItemPreview extends AbsDisplay {
	...
	protected DriveItemPreview(AbsApplication application) {
		super(application);
		logger.info("new " + DriveItemPreview.class.getCanonicalName());
	}
