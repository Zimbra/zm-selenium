...
public class DLOwnerDeleteMembers extends AjaxCommonTest  {

	public DLOwnerDeleteMembers() {
		logger.info("New "+ DLOwnerDeleteMembers.class.getCanonicalName());
		super.startingPage = app.zPageContacts;
		super.startingAccountPreferences = null;
	}

	@Test( description = "Modify DL by adding list owners and owner deletes DL", groups = { "functional" })

	public void DLOwnerDeleteMembers_01() throws HarnessException {
