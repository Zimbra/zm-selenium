...
public class Bug52121 extends PrefGroupMailByMessageTest {
	...
	@Bugs(	ids = "52121")
	@Test(	description = "Verify bug 52121:  feed-generated messages do not render in AJAX client ",
			groups = { "test" })
	public void Bug_52121() throws HarnessException {
