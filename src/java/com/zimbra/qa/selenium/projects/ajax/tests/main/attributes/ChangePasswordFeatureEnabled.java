...
public class ChangePasswordFeatureEnabled extends AjaxCore {

	public ChangePasswordFeatureEnabled() {
		logger.info("New " + ChangePasswordFeatureEnabled.class.getCanonicalName());
	...
	public void ChangePasswordFeatureEnabled_01() throws HarnessException {
