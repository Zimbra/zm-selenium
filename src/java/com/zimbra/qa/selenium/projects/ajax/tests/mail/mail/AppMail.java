...
public class AppMail extends SetGroupMailByMessagePreference {
	...
	public void AppMail_01() throws HarnessException {
		...
		// The body could contain HTML, even though it is only displaying text (e.g. <br> may be present) do a contains, rather than equals.
