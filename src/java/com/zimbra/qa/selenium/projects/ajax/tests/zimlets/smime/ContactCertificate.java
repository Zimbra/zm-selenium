...
public class ContactCertificate extends AjaxCommonTest {
	...
	public void ContactDeleteCertificate_01() throws HarnessException  {
       ...
       //Verify that contact's certificate row is not present
		...
		ZAssert.assertFalse(app.zPageContacts.sIsElementPresent(com.zimbra.qa.selenium.projects.ajax.ui.contacts.PageContacts.Locators.zViewCertificate), "Verify that view certificate link is not present");
