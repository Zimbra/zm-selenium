...
public class Bug49924 extends CalendarWorkWeekTest {

	public Bug49924() {
		logger.info("New " + Bug49924.class.getCanonicalName());
		super.startingPage = app.zPageCalendar;
	}

	@Bugs( ids = "49924")
	@Test(
			description = "Bug 49924 - 'Direct link for Zimbra calendar fails when no calendars are checked'", 
			groups = { "functional" })
	public void Bug49924_01() throws HarnessException {
