...
public class ReplyWithMultiLineTextSignature extends AjaxCore {

	@SuppressWarnings("serial")
	public ReplyWithMultiLineTextSignature() {
	...
	/**
	 * Test case : Reply message with text signature and Verify signature through
	 * soap Create signature through soap Send message with text signature
	 * through soap Reply same message. Verify text signature in Replied message
	 * through soap
	 */
	...
	public void ReplyWithMultiLineTextSignature_01() throws HarnessException {
		...
		ZAssert.assertEquals(signature.getName(), sigName, "Verify text signature is created");
		...
		// Verify TO, Subject, Text Body,Text Signature for replied message
