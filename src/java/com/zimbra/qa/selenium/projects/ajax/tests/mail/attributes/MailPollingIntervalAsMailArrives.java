...
public class MailPollingIntervalAsMailArrives extends SetGroupMailByMessagePreference {

	public MailPollingIntervalAsMailArrives() {
		logger.info("New "+ MailPollingIntervalAsMailArrives.class.getCanonicalName());
		super.startingAccountPreferences.put("zimbraPrefMailPollingInterval", ""+ com.zimbra.qa.selenium.projects.ajax.tests.preferences.mail.displayingmessages.MailPollingIntervalAsMailArrives.AsMailArrives);
	}
	...
	public void MailPollingIntervalAsMailArrives_01() throws HarnessException {
		...
		SleepUtil.sleep(com.zimbra.qa.selenium.projects.ajax.tests.preferences.mail.displayingmessages.MailPollingIntervalAsMailArrives.AsMailArrivesDelay);
