...
public class IncludeTrashInSearchFalse extends SetGroupMailByMessagePreference {
	...
	@Test (description = "Verify when zimbraPrefIncludeTrashInSearch=FALSE, that trash is *not* included in search",
