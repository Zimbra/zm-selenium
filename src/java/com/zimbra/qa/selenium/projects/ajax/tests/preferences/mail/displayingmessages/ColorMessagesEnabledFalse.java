...
public class ColorMessagesEnabledFalse extends AjaxCore {

	public ColorMessagesEnabledFalse() {
		logger.info("New "+ ColorMessagesEnabledFalse.class.getCanonicalName());
