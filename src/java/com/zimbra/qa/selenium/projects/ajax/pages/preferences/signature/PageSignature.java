 ...
 * ***** END LICENSE BLOCK *****
 */
package com.zimbra.qa.selenium.projects.ajax.pages.preferences.signature;
...
public class PageSignature extends AbsTab {
	...
	public AbsPage zToolbarPressButton(Button button) throws HarnessException {
		...
		if (button == Button.B_NEW) {
			...
			page = new DialogSelectContact(MyApplication, ((AjaxPages) MyApplication).zPageSignature);
