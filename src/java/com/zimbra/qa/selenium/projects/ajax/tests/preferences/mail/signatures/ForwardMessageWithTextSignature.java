...
public class ForwardMessageWithTextSignature extends AjaxCommonTest {
	String sigName = "signame" + ConfigProperties.getUniqueString();
	String sigBody = "sigbody" + ConfigProperties.getUniqueString();

	@SuppressWarnings("serial")
	public ForwardMessageWithTextSignature() {
	...
	/**
	 * Test case : Forward message with text signature and Verify signature through
	 ...
	 * signature in forwarded message through soap
	 */

	@Test (description = "Forward message with text signature and verify signature through soap",
			groups = { "functional", "L2" })

	public void ForwardMessageWithTextSignature_01() throws HarnessException {
