...
public class DialogEditQuickCommand extends AbsDialog {
	...
	public void zSetQuickCommandActive(boolean active) throws HarnessException {
	...
	public void zSetQuickCommandType(QuickCommandType type) throws HarnessException {
	...
	public void zSetQuickCommandActionActive(int index, boolean active) throws HarnessException {
	...
	public void zSetQuickCommandActionOperation(int index, QuickCommandOperation operation) throws HarnessException {
		...
		String pulldownLocator = "css=div[id='ZmQuickCommandDialog1'] tbody[id='ZmQuickCommandDialog1_actionsTbody']"
				+ StringUtils.repeat(" tr", index) + " td[id$='_select_container'] td[id$='_dropdown']>div";
		String optionLocator = null;
	...
	public AbsPage zSetQuickCommandActionTarget(int index, QuickCommandTarget target) throws HarnessException {
		...
		if (target.equals(QuickCommandTarget.Browse)) {
			...
			String locator = "css=div[id='ZmQuickCommandDialog1'] tbody[id='ZmQuickCommandDialog1_actionsTbody']"
					+ StringUtils.repeat(" tr", index) + " td[id$='_select_container'] td[id$='_title']";

			String operation = this.sGetText(locator);

			if (operation.equals("Move into folder")) {

				page = new DialogMove(MyApplication, ((AjaxPages) MyApplication).zPagePreferences);

			} else if (operation.equals("Tag with")) {

				page = new DialogTag(MyApplication, ((AjaxPages) MyApplication).zPagePreferences);
