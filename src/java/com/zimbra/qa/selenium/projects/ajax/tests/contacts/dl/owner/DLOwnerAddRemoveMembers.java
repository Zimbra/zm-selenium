 ...
 * ***** END LICENSE BLOCK *****
 */
package com.zimbra.qa.selenium.projects.ajax.tests.contacts.dl.owner;
...
public class DLOwnerAddRemoveMembers extends AjaxCommonTest  {

	public DLOwnerAddRemoveMembers() {
		logger.info("New "+ DLOwnerAddRemoveMembers.class.getCanonicalName());
		super.startingPage = app.zPageContacts;
		super.startingAccountPreferences = null;
	}

	@Test( description = "Modify DL by adding list owners and owner adds one more member", groups = { "functional" })

	public void DLOwnerAddRemoveMembers_01() throws HarnessException {
		...
		ZAssert.assertFalse(found1, "Verify member 1 is not the DL");
