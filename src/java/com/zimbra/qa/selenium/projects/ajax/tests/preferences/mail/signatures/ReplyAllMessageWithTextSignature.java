...
public class ReplyAllMessageWithTextSignature extends AjaxCommonTest {
	String sigName = "signame" + ConfigProperties.getUniqueString();
	String sigBody = "Signature" + ConfigProperties.getUniqueString();

	@SuppressWarnings("serial")
	public ReplyAllMessageWithTextSignature() {
	...
	/**
	 * Test case : Reply All message with text signature and Verify signature
	 ...
	 * Replied message through soap
	 */

	@Test (description = "Reply all message with text signature and verify signature through soap",
			groups = { "functional", "L3" })

	public void ReplyAllMessageWithTextSignature_01() throws HarnessException {
