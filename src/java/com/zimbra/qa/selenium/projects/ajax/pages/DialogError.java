...
/**
 * A <code>DialogError</code> object represents a "Error" dialog, such as
...
public class DialogError extends DialogWarning {
	...
	public static class DialogErrorID extends DialogWarning.DialogWarningID {
		...
		/**
		 * General "Zimbra" server error (such as PERM_DENIED, etc.) See:
		 * https://bugzilla.zimbra.com/show_bug.cgi?id=57207
		 */
