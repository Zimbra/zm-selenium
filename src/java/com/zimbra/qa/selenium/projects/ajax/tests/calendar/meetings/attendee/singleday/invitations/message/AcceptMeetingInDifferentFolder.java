...
public class AcceptMeetingInDifferentFolder extends AjaxCore {

	public AcceptMeetingInDifferentFolder() {
		logger.info("New "+ AcceptMeetingInDifferentFolder.class.getCanonicalName());
