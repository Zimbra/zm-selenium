...
public class ReplyForwardWithTextSignatureAboveIncludedMessage extends AjaxCommonTest {
	String sigName = "signame" + ConfigProperties.getUniqueString();
	String sigBody = "sigbody" + ConfigProperties.getUniqueString();

	@SuppressWarnings("serial")
	public ReplyForwardWithTextSignatureAboveIncludedMessage() {
	...
	/**
	 * Test case : Verify text signature above included message While Replying Create
	...
	@Test (description = "Verify text signature above included message when replying",
			groups = { "functional", "L3" })

	public void ReplyWithTextSignatureAboveIncludedMessage_01() throws HarnessException {
		...
		actual.zVerifySignaturePlaceInText("AboveIncludedMessage", this.sigBody, "Reply");
	}
	...
	public void ReplyAllWithTextSignatureAboveIncludedMessage_02() throws HarnessException {
	...
	/**
	 * Test case : Verify text signature above included message when forwarding Create
	 * signature through soap Send message with text signature through soap
	 * Select Same message and click Fwd Click Options dropdown and select Signature
	 * Verify signature should place above included message when forwarding message
	 */

	@Test (description = "Verify text signature above included message when forwarding",
			groups = { "functional", "L2" })

	public void ForwardWithTextSignatureAboveIncludedMessage_03() throws HarnessException {
		...
		// Verify Signature is place above included message.
		actual.zVerifySignaturePlaceInText("AboveIncludedMessage", this.sigBody, "Forward");
	}
}