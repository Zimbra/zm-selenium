...
public class SelectionCheckboxMoveMessage extends SetGroupMailByMessagePreference {

	public SelectionCheckboxMoveMessage() {
		logger.info("New "+ SelectionCheckboxMoveMessage.class.getCanonicalName());
	...
	public void SelectionCheckboxMoveMessage_01() throws HarnessException {
	...
	public void SelectionCheckboxMoveMessage_02() throws HarnessException {
