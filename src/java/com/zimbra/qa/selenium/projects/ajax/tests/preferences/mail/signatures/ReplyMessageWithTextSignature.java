...
public class ReplyMessageWithTextSignature extends AjaxCommonTest {
	String sigName = "signame" + ConfigProperties.getUniqueString();
	String sigBody = "Signature" + ConfigProperties.getUniqueString();

	@SuppressWarnings("serial")
	public ReplyMessageWithTextSignature() {
	...
	public void ReplyMessageWithTextSignature_01() throws HarnessException {
