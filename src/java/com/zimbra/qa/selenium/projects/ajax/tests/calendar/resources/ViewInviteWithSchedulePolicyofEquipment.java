...
public class ViewInviteWithSchedulePolicyofEquipment extends CalendarWorkWeekTest {	
	...
	@Test(description = "Verify that invite appears correctly in resource's account when schedule policy is set to 'Auto accept if available, auto decline on conflict'",
			groups = { "functional" })
	
	public void AutoAcceptIfAvailableAutoDeclineOnCOnflict_01() throws HarnessException {
	...
	public void ManualAcceptAutoDeclineOnConflict_02() throws HarnessException {
	...
	@Test(description = "Verify that invite appears correctly in resource's account when schedule policy is set to 'Auto accept always'",
			groups = { "functional" })
	public void AutoAcceptAlways_03() throws HarnessException {
	...
	@Test(description = "Verify that invite appears correctly in resource's account when schedule policy is set to 'No auto accept or decline'",
			groups = { "functional" })
	public void NoAutoAcceptOrDecline_04() throws HarnessException {
