...
public class AvailableZimlets extends AjaxCore {

	@SuppressWarnings("serial")
	public AvailableZimlets() {
		logger.info("New "+ AvailableZimlets.class.getCanonicalName());
	...
	public void AvailableZimlets_01() throws HarnessException {
