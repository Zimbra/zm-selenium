...
public class FormContactGroupNew extends AbsForm {
	...
	public AbsPage zToolbarPressButton(Button button) throws HarnessException {
		...
		if (button == Button.B_SAVE) {
			...
			page = new DialogMove(MyApplication, ((AjaxPages) MyApplication).zPageContacts);
	...
	public void select(AjaxPages app, String dropdown, String option) throws HarnessException {
