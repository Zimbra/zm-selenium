...
public class CheckEditedMessageAfterCancellingInvite extends AjaxCore {

	public CheckEditedMessageAfterCancellingInvite() {
		logger.info("New "+ CheckEditedMessageAfterCancellingInvite.class.getCanonicalName());
	...
	public void CheckEditedMessageAfterCancellingInvite_01() throws HarnessException {
