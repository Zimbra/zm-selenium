...
public class ConfirmationPageEnabled extends SetGroupMailByMessagePreference {

	public ConfirmationPageEnabled() {
		logger.info("New "+ ConfirmationPageEnabled.class.getCanonicalName());
