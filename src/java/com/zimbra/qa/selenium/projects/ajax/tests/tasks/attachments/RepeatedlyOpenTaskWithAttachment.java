...
public class RepeatedlyOpenTaskWithAttachment extends AjaxCore {
	...
	public void RepeatedlyOpenTaskWithAttachment_01() throws HarnessException {
		...
		ZAssert.assertTrue(app.zPageTasks.sIsElementPresent(com.zimbra.qa.selenium.projects.ajax.pages.tasks.FormTaskNew.Locators.zCloseButton), "Verify Close button is there");
		...
		app.zPageTasks.sClickAt(com.zimbra.qa.selenium.projects.ajax.pages.tasks.FormTaskNew.Locators.zCloseButton, "0,0");
