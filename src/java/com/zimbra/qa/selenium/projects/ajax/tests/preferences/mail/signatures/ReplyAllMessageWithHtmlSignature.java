...
public class ReplyAllMessageWithHtmlSignature extends AjaxCommonTest {
	...
	public ReplyAllMessageWithHtmlSignature() {
	...
	/**
	 * Test case : ReplyAll message with html signature and Verify signature through
	 * soap Create signature through soap Send message with html signature
	 * through soap ReplyAll same message Verify html signature in replied message
	 * through soap
	 */

	@Test (description = "Reply all message with html signature and verify signature through soap",
			groups = { "functional", "L2" })

	public void ReplyAllMessageWithHtmlSignature_01() throws HarnessException {
