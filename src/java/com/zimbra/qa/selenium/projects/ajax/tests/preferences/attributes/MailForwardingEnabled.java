...
public class MailForwardingEnabled extends AjaxCore {

	public MailForwardingEnabled() {
		logger.info("New "+ MailForwardingEnabled.class.getCanonicalName());
	...
	public void MailForwardingEnabled_02() throws HarnessException {
