...
public class ForwardUnsignedMail extends AjaxCommonTest {
	...
	public void ForwardUnsignedMailAsSigned_01() throws HarnessException  {
		...
		mailform.zFillField(com.zimbra.qa.selenium.projects.ajax.ui.mail.FormMailNew.Field.To, ZimbraAccount.Account1().EmailAddress);
	...
	public void ForwardUnsignedMailAsSignedAndEncrypted_02() throws HarnessException  {
		...
		// Fill out the form with the data
		mailform.zFillField(com.zimbra.qa.selenium.projects.ajax.ui.mail.FormMailNew.Field.To, user5.EmailAddress);
