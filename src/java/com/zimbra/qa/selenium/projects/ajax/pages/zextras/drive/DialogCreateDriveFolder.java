...
public class DialogCreateDriveFolder extends AbsDialog {
	...
	public static class Locators {
		...
		public static final String zTitle = "css=td[id=CreateNewFolderDialog_title]:contains(Create New Folder)";
		public static final String zNameField = "css=div[id=CreateNewFolderDialog] input[id='CreateNewFolderDialog']";
		public static final String zDialogButtonsId = "ChooseFolderDialog_buttons";
		public static final String zOkButton = "css=div[id=CreateNewFolderDialog] td[class='ZWidgetTitle']:contains('OK')";
		public static final String zCancelButton = "css=div[id=CreateNewFolderDialog] td[class='ZWidgetTitle']:contains('Cancel')";
	}

	public DialogCreateDriveFolder(AbsApplication application, AbsTab tab) {
		super(application, tab);
		logger.info("new " + DialogCreateDriveFolder.class.getCanonicalName());
	}
	...
	public boolean zIsActive() throws HarnessException {
		...
		String locator = Locators.zTitle;
