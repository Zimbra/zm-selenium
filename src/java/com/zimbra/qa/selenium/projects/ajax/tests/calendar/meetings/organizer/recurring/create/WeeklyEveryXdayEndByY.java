...
public class WeeklyEveryXdayEndByY extends AjaxCommonTest {
	...
	@Test( description = "Create weekly recurring invite with attendee and location which ends by particular date",
			groups = { "smoke", "L1" })
