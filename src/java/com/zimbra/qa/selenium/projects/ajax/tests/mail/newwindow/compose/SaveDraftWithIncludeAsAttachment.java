...
public class SaveDraftWithIncludeAsAttachment extends SetGroupMailByMessagePreference {

	public SaveDraftWithIncludeAsAttachment() {
		logger.info("New "+ SaveDraftWithIncludeAsAttachment.class.getCanonicalName());
