...
public class CreateMeetingWithLocation extends AjaxCore {
	...
	public void CreateMeetingWithSingleLocation_01() throws HarnessException {
		...
		apptLocation1 = ExecuteHarnessMain.locations.get("location1")[1];
	...
	public void CreateMeetingWithMultiLocation_02() throws HarnessException {
		...
		apptSubject = ConfigProperties.getUniqueString();
		apptAttendee1 = ZimbraAccount.AccountA().EmailAddress;
		apptLocation = ExecuteHarnessMain.locations.get("location1")[1] + " "
				+ ExecuteHarnessMain.locations.get("location2")[1];
