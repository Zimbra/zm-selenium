...
public class DeleteAddressContextMenu extends PrefGroupMailByMessageTest {
	...
	@Test(description = "Right click Cc bubble address>>Delete", groups = { "smoke-temp-skipped" })
	...
	@Test(description = "Right click BCc bubble address>>Delete", groups = { "smoke-temp-skipped" })
