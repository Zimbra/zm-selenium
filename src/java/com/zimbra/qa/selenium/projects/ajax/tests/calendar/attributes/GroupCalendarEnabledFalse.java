...
public class GroupCalendarEnabledFalse extends AjaxCore {

	public GroupCalendarEnabledFalse() {
		logger.info("New "+ GroupCalendarEnabledFalse.class.getCanonicalName());
