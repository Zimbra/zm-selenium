...
public class MonthlyRecurringNoEndDate extends AjaxCommonTest {
	...
	public void MonthlyRecurringNoEndDate_01() throws HarnessException {
		...
		ZAssert.assertEquals(app.zPageCalendar.zGetRecurringLink(), "Day " + Integer.parseInt(new SimpleDateFormat("dd").format(Calendar.getInstance().getTime())) + " of every 1 month(s). No end date. Effective " + startUTC.toTimeZone(tz).toMMM_dC_yyyy(), "Recurring link: Verify the appointment data");
