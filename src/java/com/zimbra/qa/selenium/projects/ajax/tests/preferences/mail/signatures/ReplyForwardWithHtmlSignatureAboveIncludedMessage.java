...
public class ReplyForwardWithHtmlSignatureAboveIncludedMessage extends AjaxCommonTest {
	...
	public ReplyForwardWithHtmlSignatureAboveIncludedMessage() {
	...
	public void ReplyWithHtmlSignatureAboveIncludedMessage_01() throws HarnessException {
	...
	/**
	 * Test case : Verify html signature placed above included message While
	...
	@Test (description = "Verify html signature placed above included message when replying all",
			groups = { "functional", "L2" })

	public void ReplyAllWithHtmlSignatureAboveIncludedMessage_02() throws HarnessException {
		...
		// Verify Signature is place above included message.
		actual.zVerifySignaturePlaceInHTML("AboveIncludedMessage", this.sigBody, "ReplyAll");
	}


	/**
	 * Test case : Verify html signature above included message when forwarding Create
	 * html signature through soap Send message through soap Select Same message and
	 * click Fwd Click Options dropdown and select Signature Verify signature
	 * should place above included message when forwarding message
	 */

	@Test (description = "Verify html signature place above included message when forwarding",
			groups = { "functional", "L2" })

	public void ForwardWithHtmlSignatureAboveIncludedMessage_03() throws HarnessException {
		...
		// Verify Signature is place above included message.
		actual.zVerifySignaturePlaceInHTML("AboveIncludedMessage", this.sigBody, "Forward");
	}
}